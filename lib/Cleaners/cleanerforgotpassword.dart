...
class CleanerForgotPassword extends StatefulWidget {
  CleanerForgotPassword({Key? key}) : super(key: key);

  @override
  _CleanerForgotPasswordState createState() => _CleanerForgotPasswordState();
}

class _CleanerForgotPasswordState extends State<CleanerForgotPassword> {
